package com.example.locationtestingapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    //Initializing FusedLocationProvider Client

    FusedLocationProviderClient mFusedLocationClient;

    //initializing text view for displaying location
    //from layout file
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //calling method to get last location
